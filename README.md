...
- Follow the visual guide to build an *Automatic* or *Manual* model with the **customer_churn.csv** file.  This file contains the merged data from the customer.csv and churn.csv.
